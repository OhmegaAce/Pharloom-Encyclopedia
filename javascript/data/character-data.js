const characterData = {
  merchants: [
    ...
    },
    {
      ...
      background:
        "<p>Frey is Bellhart's shopkeeper. She was able to avoid Widow's control during Bellhart's Haunting.</p>",
      events:
        "<p>Frey sells her wares to Hornet in exchange for Rosaries, expanding her stock after the completion of the My Missing Courier Wish and again after the Bellhome has been acquired.</p>",
    },
    {
      name: "Grindle",
    ...
    },
    {
      ...
      background:
        "<p>Jubilana is a pilgrim and merchant. After completing her pilgrimage to the Citadel, she remained there.</p>",
      events:
        "<p>After completing the The Wandering Merchant wish, Jubilana will set up shop in Songclave. She may also be found scavenging several rooms, including:</p><ul><li>A small chamber north of the Grand Bellway</li><li>The Forum room, after completing the enemy gauntlet</li></ul><p>After the Faydown Cloak is obtained and the task Strengthening Songclave is completed, Jubilana will disappear from Songclave and will be the subject of the The Lost Merchant wish. Completing that wish returns her to Songclave with an expanded inventory.</p>",
    },
    {
      name: "Kratt",
    ...
    },
    {
      ...
      background: "Missing information",
      events:
        "<p>After defeating Widow, Loddie and his assistant will take up residence in the prison in The Marrow. Once Loddie moves in, the area will be decorated with hanging pink-purple lights. The signs pointing to the Bench will be covered with a purple cloth with 3 white pins, and the prison door will glow with light from within.</p><p>Speaking with Loddie will prompt him to invite Hornet to play a pin-throwing game for a prize.</p>",
    },
    {
    ...
    },
    {
      ...
      background: "Missing Information",
      events:
        "<p>Pebb is the first merchant encountered in Pharloom. If Hornet buys all of her stock, Pebb decides to finally close the shop and continue her pilgrimage to the Citadel, with her tent disappearing once Hornet leaves town again.</p><p>She can later be found as an enemy haunted by silk in the easternmost room of The Marrow that connects it to Deep Docks. Her merchant bag is nearby and upon defeat, she drops 55 rosaries.</p>",
    },
    {
    ...
    },
    {
      ...
      background:
        "<p>Shakra is a warrior and navigator from a tribe from outside Pharloom. She is seeking her master who disappeared, singing to help locate her.</p><p>Shakra's tribe values prowess in combat and refer to one another by the weapon they carry.</p>",
      events:
    ...
    },
    {
      ...
      background: "Missing information",
      events:
        "<p>Hornet encounters Skynx behind a breakable wall east of Styx's original Bench, in the easternmost room of Sinner's Road. They are originally shrouded by darkness, but emerge when Hornet notices them.</p><p>They request Silkeaters from Hornet, providing large amounts of Rosaries in exchange.</p>",
    },
    {
      name: "Tipp & Pill",
  ...
  wanderers: [
    ...
    },
    {
      ...
      background: "Missing information",
      events:
        "<p>After the Flea Caravan moves to Greymoor, Fleamaster Mooshka will give Hornet the Flea Brew as a reward, which can be refilled by interacting with the pot next to Grishkin for 30.</p>",
    },
    {
      name: "Pilby",
    ...
    },
    {
      ...
      background:
        "<p>Shrine Guardian Seth serves as the eternal guardian to the Shellwood Shrine containing the monument to Nyleth, which he defends by entering into combat with anyone who attempts to pass him. He has slain many bugs in his defence of the shrine, a fact he seems to feel some regret for.</p>",
      events:
        "<p>Shrine Guardian Seth is first encountered guarding the shrine in Shellwood. He falls into the waters of Shellwood once he is defeated.</p><p>After his defeat, Seth appears in Greymoor, revealing he survived his battle with Hornet. He has seemingly lost his memory and does not recognise Hornet. He says that he is now travelling Pharloom. He can be next found in Shellwood, east of the Bellway, and then the Grand Gate, just outside the entrance to the Citadel. The final appearance in the Grand Gate can be skipped if the Everbloom has been obtained.</p><p>Once the Everbloom has been obtained, Seth will take his final resting spot in the Festival of the Flea if it has started. Seth holds the highest score out of the NPCs in all 3 of the Flea games, and beating his high score in each game grants the Guardian's Memento.</p>",
    },
    {
      name: "Varga",
  ...
  questNpcs: [
    ...
    },
    {
      ...
      events:
        "<p>On first encounter, the Caretaker is hiding in a tent outside of the First Shrine. After Hornet purchases the Bench inside and rings the bell, he then reveals himself and starts talking with Hornet as a bellringer. After resting on a Bench in a different area, upon returning the area surrounding the bell will be transformed into Songclave.</p>",
    },
    {
    ...
    },
    {
      ...
      background:
        "<p>Loyal Mergwin is a servant of the Citadel who resides in Choral Chambers. He serves the Great Gourmand, attempting to provide food to satiate their substantial appetite.</p><p>He planned to prepare a great meal for the Gourmand, but was unable to gather the required ingredients himself.</p>",
      events:
        "<p>Speaking to Loyal Mergwin begins the Great Taste of Pharloom Wish. They ask for a Mossberry Stew, Vintage Nectar, Pickled Muckmaggot, Courier's Rasher and Crustnut to feed the Great Gourmand.</p><p>Upon completion of the wish, he gives Hornet 1x Pale Oil.</p>",
    },
    {
      ...
      background: "Missing information",
      events:
        "<p>Finding him in all seven locations in order and ending the game rewards the Passing of the Age achievement and a secret cutscene after beating the game.</p><p>At each location, he is found buried under the ground with mushrooms indicating his location. Playing the Needolin draws him out and allows Hornet to attempt to converse with him.</p>",
    },
    {
      name: "Moss Druid",
    ...
    },
    {
      ...
      events:
        "<p>Talking to Seamstress in her hut in Far Fields begins the Flexile Spines wish. Upon completing the wish, Seamstress will upgrade the Hunter's Cloak into the Drifter's Cloak.</p>",
    },
    {
      name: "Snail Shamans",
    ...
    },
    {
      ...
      background:
        "<p>Zi has unseen masters, who she shares with Sula and seem to share with Steel Soul Jinn and Confessor Jiji.</p>",
  ...
  miscellaneous: [
    ...
    },
    {
      ...
      events:
        "<p>Broodling appears in a pile of muck in the Broodmother arena a short while after defeating her.</p>",
    },
    {
      name: "Chapel Maid",
    ...
    },
    {
      ...
      background:
        "<p>The Fayforn is a creature who resides at the top of Mount Fay. In the past, the Weavers built passages and a tuning fork into the mountain for the purpose of communing with her.</p>",
      events:
        "<p>Once Hornet reaches the tuning fork at the peak of Mount Fay and plays the Needolin, the Fayforn descends and grants Hornet her down to create the Faydown Cloak. The Mask Maker seems impressed with this gift and with the fact that the Fayforn has lended Hornet her aid.</p><p>Like the Bell Beast, the Fayforn has no Needolin dialogue, although she coos when the Needolin is played</p><p>Later, in Act 3, the Fayforn will appear during the Passing of an Age wish, where Mr. Mushroom will be talking to the bird.</p>",
    },
    {
      ...
      background: "Missing information",
      events:
        "<p>At the beginning of the game, Flick builds a Wishwall in Bone Bottom, allowing Hornet to take quests. When completing all available quests there, he grants a Hornet Statuette.</p>",
    },
    {
      name: "Loam",
    ...
    },
    {
      ...
      events:
        "<p>Old Penitent can be found in their cell in the Slab. They are hiding within the cell and will only emerge when Hornet plays the Needolin.</p>",
    },
    {
      name: "Pious Isamor",
      ...
      events:
        "<p>Pious Isamor initially appears to be a rusted statue of a pilgrim. Upon walking a few steps away, hitting it a few times or playing the Needolin, it will wake up and can be listened to. They make a rumbling sound when talking.</p>",
    },
    {
      ...
      events:
        "<p>When Hornet first arrives in Bellhart, Pondcatcher Reed, along with other residents, is found suspended in the air with silk threads. After Widow is defeated, Pondcatcher Reed and the other residents are released and they return to the their normal functions.</p>",
    },
    {
    ...
    },
    {
      ...
      events:
        "<p>The old and tired Karmelita can be found in the Far Fields, during Act 3. During the SEEK: The Old Hearts Wish, Hornet can play the Elegy of the Deep next to the queen and enter her memory, where she must fight Karmelita in her prime. Before fighting Skarrsinger Karmelita herself, Hornet must first endure a short enemy gauntlet, consisting of 2 Skarr Scouts, 2 Skarr Stalkers, 1 Spear Skarr and 2 Last Claws. Defeating Skarrsinger Karmelita grants Hornet the Hunter's Heart.</p>",
    },
    {
      name: "Styx",
    ...
    },
    {
      ...
      events:
        "<p>Sula and its location will only appear after you accept the wish A Vassal Lost and find all three locations to advance to the final step.</p>",
    },
  ],
};
